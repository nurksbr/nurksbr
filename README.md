# ⚙️ | Fevziye Nur KESEBİR — Developer & Cyber Security Learner
...
- 💻 Çok dilli projeler: Java, TypeScript, Python, C#  
- 🌐 Web, backend ve siber güvenlik odaklı gelişim  
- 🔍 Gerçek sorunlara minimal çözümler üretmeyi seven biri  
- 📦 30+ repo ile aktif öğrenme sürecinde  

---

## 📌 Highlighted Projects
- 🔹 [Momentum](https://github.com/nurksbr/momentum) – minimalist habit tracker  
- 🔹 [Java Applications](https://github.com/nurksbr/JavaApps) – console & UI tools  
...
> **"Learn by building. Break to fix. Repeat forever."**
...
🔹 Cloud, DevOps, CI/CD öğrenimi
🔹 Open-source dünyasına katkı

---

## 📫 Reach Me

🐙 GitHub   : https://github.com/nurksbr
🌐 Website  : https://fevziyenurkesebir.com
📬 Email    : fnurks1@hotmail.com
...
![Metrics](https://metrics.lecoq.io/nurksbr?template=classic&config.timezone=Europe/Istanbul)
