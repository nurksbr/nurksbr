<div align="center">
  ...
  <h1>👋 Merhaba, Ben Fevziye Nur KESEBİR</h1>
  <p><strong>Software Engineering Student | Security Enthusiast | Full-Stack Developer</strong></p>
...
* 🎓 **Eğitim:** Fırat Üniversitesi — Yazılım Mühendisliği
* 🎯 **Odak Alanları:** Web & Backend Geliştirme, Siber Güvenlik, PWA & Görüntü İşleme
* 🔍 **Yaklaşım:** Karmaşık problemleri tespit edip minimal ve ölçeklenebilir çözümler üretmek
* 📦 **Aktif Öğrenme:** 30+ açık kaynak repository ve sürekli geliştirilen projeler
...
| :--- | :--- |
| **Diller** | `Java` `TypeScript` `JavaScript` `Python` `C#` |
| **Frontend** | `React` `Vite` `HTML5` `CSS3` |
| **Backend & DB** | `Node.js` `Java` `Python` `MongoDB` |
| **Siber Güvenlik** | `Kali Linux` `Wireshark` `Burp Suite` |
| **Araçlar & İşletim Sistemi** | `Git` `GitHub` `VS Code` `Linux` `Windows` |
...
| :--- | :--- | :---: |
| ⚡ **Momentum** | Minimalist alışkanlık takip uygulaması | [Repo ↗](https://github.com/nurksbr/momentum) |
| ☕ **Java Applications** | Konsol ve arayüz tabanlı Java araçları | [Repo ↗](https://github.com/nurksbr/JavaApps) |
| 🍃 **Python + MongoDB** | Veritabanı mimarisi ve veri işleme çalışmaları | [Repo ↗](https://github.com/nurksbr/python-mongo) |
| 🎮 **C# Game Projects** | C# ile geliştirilmiş mini oyun projeleri | [Repo ↗](https://github.com/nurksbr/FlappyBird) |
